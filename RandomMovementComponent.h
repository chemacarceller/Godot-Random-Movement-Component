...
class RandomMovementComponent : public Node {
    ...
    private:
        ...
        // The radius of the circle in which the movement occurs
    ...
    public:
        ...
        void set_movementRadius(float value) { _movementRadius = value; }
        float get_movementRadius() const { return _movementRadius; }
};
